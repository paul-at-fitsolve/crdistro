...
<div class="row">
  <div class="col-sm-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><?php print render($form['use_custom_classes']) ?></h3>
      </div>
      <?php print render($form['custom_classes']) ?> 
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><?php print render($form['use_data_attributes']) ?></h3>
      </div>
      <?php print render($form['data_attributes']) ?> 
    </div>
  </div>
</div>
